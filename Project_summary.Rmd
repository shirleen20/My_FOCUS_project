...
# Introduction
My name is *Shirleen Prasad*. I am a 3rd year PhD candidate working in collaboration with Macquarie University & CSIRO. My PhD project investigates the genetic basis of reduced stress tolerance in domesticated Queensland fruit flies (Q-fly), _Bactrocera_ _tryoni_. Before joining Data School, I mostly used excel for data analysis and could only perform basic statistical analysis in R. Gaining competence in R through this course has given me confidence in using R independently. 
